...
import combatRobotics from "../assets/divisions/crt-cover.png";
...
const DivisionsGrid = () => {
  const divisionInfo = [
    ...
    },
    {
      ...
      imageLink: combatRobotics,
      href: "/divisions/combatrobotics",
    },
  ];
          ...
          <Link key={index} to={div.href}>
            ...
            >
              <div className="md:w-65 md:h-70 w-40 h-50 overflow-hidden bg-white rounded-lg shadow-lg">
                <img
                  className="object-cover w-full md:h-55 h-35"
                  src={div.imageLink}
                  alt="avatar"
                />
                ...
                <div className="py-5 text-center">
                  <a
                    href="#"
                    className="font-geist block text-xl font-bold text-gray-800 "
                    role="link"
                  >
                    {div.title}
                  </a>
