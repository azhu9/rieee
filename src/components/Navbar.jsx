...
const Navbar = () => {
  ...
  const divisionLinks = [
    ...
    { href: "/divisions/combatrobotics", label: "RUCRT" },
  ];
      ...
      <div className="w-full flex justify-between items-center container mx-auto px-4 sm:px-6 lg:px-8 md:h-20 h-16">
        ...
        >
          ...
          <div className="relative inline-block">
            ...
            <div
              className={`absolute top-full left-0 mt-7 w-30 rounded-b-lg p-3 shadow-md bg-white transition-transform origin-top duration-200 z-50 ${
